...
class Platform(Element):
    def __init__(self, *args, **kwargs):
        ...
        self.block_docstrings_loaded_callback = (
            lambda: None
    ...
    def load_and_generate_flow_graph(self, file_path, out_path=None, hier_only=False):
        ...
        try:
            ...
            if hier_only and not flow_graph.get_option("generate_options").startswith(
                "hb"
            ):
            ...
            for file_path in self._iter_files_in_block_path(path):
                ...
                try:
                    ...
                    for msg in checker.messages:
                        logger.warning(
                            "{:<40s} {}".format(os.path.basename(file_path), msg)
                        )
                    if not passed:
    ...
    block_classes = utils.backports.ChainMap(
